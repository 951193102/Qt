<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="MyWord.aspx.cs" Inherits="Default2" Title="留言信息管理" %>
                            ...
                            <tr>
                                ...
                                <td colspan="2" style="font-size: 9pt; width: 382px; text-align: right">
                                    <a href='LeaveWordBack.aspx?ID=<%#DataBinder.Eval(Container,"DataItem.ID") %>' style="color: #0000ff;
                                        text-decoration: none"><span style="color: #000000"></span></a><a href='leaveWordView.aspx?ID=<%#DataBinder.Eval(Container,"DataItem.ID") %>'
