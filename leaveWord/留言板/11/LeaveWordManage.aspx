<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="LeaveWordManage.aspx.cs" Inherits="Default2" Title="留言信息管理" %>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2" style="font-size: 9pt; width: 382px; text-align: right">
                                                <a href='LeaveWordBack.aspx?ID=<%#DataBinder.Eval(Container,"DataItem.ID") %>' style="color: #0000ff;
                                                    text-decoration: none"><span style="color: #000000">回复留言</span></a> <a href='leaveWordView.aspx?ID=<%#DataBinder.Eval(Container,"DataItem.ID") %>'
                                                        style="font-size: 9pt; color: #0000ff; text-decoration: none"><span style="color: #000000">
                                                            查看回复</span></a>
                                                <asp:LinkButton ID="lnkbtnDelete" runat="server" CommandName="delete" Font-Size="9pt"
                                                    Font-Underline="False" ForeColor="Black">删除留言</asp:LinkButton>
                                            </td>
                                        </tr>
                                    </table>
                                </ItemTemplate>
